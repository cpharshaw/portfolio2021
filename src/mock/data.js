...
export const aboutData = {
  ...
  resume: 'https://drive.google.com/file/d/11dzgQX_UIfzRC2VGsWTaNYS-uMD1Pk-E/view?usp=sharing', // if no resume, the button will not show up https://www.resumemaker.online/es.php
};
