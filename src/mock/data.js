...
export const aboutData = {
  ...
  paragraphThree: `I am most experienced with the MERN stack and am really smitten with Javascript, but am always looking to expand my toolbelt. Ultimately, since entering the web development field, the top skill I've acquired is learning how to learn.  With this skill, I've set my sights on learning additional frameworks, libraries, and languages.`,
  paragraphFour_a: `As of Winter 2021, I'm seeking a full-time web developer role - front-end, back-end, or full stack.  Please don't hesitate to `,
  ...
  resume: 'https://drive.google.com/file/d/1qcJCsc0wUuV5oIl9tLA32oa2TEGFsGnY/view?usp=sharing', // if no resume, the button will not show up https://www.resumemaker.online/es.php
};
